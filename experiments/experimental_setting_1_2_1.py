...
with open('data/input/expanded_context_opt.txt', 'r') as file:
...
def call_experimental_setting_1_2_1(model_name, dataset_name, working_dir):
    tqdm.pandas()
    ...
    df.to_csv(f'data/outputs/{dataset_name}/{working_dir}/{model_name}/step_8_long_context.csv')
